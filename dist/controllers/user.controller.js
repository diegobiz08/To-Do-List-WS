...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { email, password, passwordConfirmation, NIT, name, lastName, bornDate, deliveryAddress, phoneNumber } = req.body;
    ...
    try {
        ...
        const existingDPI = yield user_1.default.findOne({ DPI });
        if (existingEmail) {
            return handleBadRequest(res, commons_1.EXISTING_EMAIL);
        }
        if (existingNIT) {
            return handleBadRequest(res, commons_1.EXISTING_NIT);
        }
        if (existingDPI) {
            return handleBadRequest(res, commons_1.EXISTING_DPI);
        }
        ...
        return handleInternalServerError(res, commons_1.SERVER_ERROR);
    }
});
